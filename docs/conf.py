...
htmlhelp_basename = 'dataclass-builderdoc'
...
latex_documents = [
    (master_doc, 'dataclass-builder.tex', 'dataclass-builder Documentation',
...
man_pages = [
    (master_doc, 'dataclass-builder', 'dataclass-builder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dataclass-builder', 'dataclass-builder Documentation',
     author, 'dataclass-builder', 'One line description of project.',
     'Miscellaneous'),
]
